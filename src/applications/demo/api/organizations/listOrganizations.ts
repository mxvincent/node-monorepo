import {
	...
	QueryStringRecord,
	QueryStringSchema
} from '@pkg/query-string'
import { CollectionPager } from '@pkg/typeorm'
...
const schema: FastifySchema = {
	...
	response: {
		200: PageSchema(OrganizationWithMembersSchema())
	}
}

const handler = async (request: FastifyRequest, reply: FastifyReply): AsyncPage<Organization> => {
